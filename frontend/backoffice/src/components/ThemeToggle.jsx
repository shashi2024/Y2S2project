...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex items-center justify-center cursor-pointer w-9 h-9 bg-color2 hover:bg-second_background dark:bg-button_color dark:hover:bg-button_hover rounded-full"
        htmlFor="light-switch"
>
        <svg className="w-5 h-5 dark:hidden mx-auto my-auto" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          <path
            className="fill-current text-button_hover"
          ...
          />
          <path className="fill-current text-button_hover" d="M8 4C5.8 4 4 5.8 4 8s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4Z" />
        </svg>
        <svg className="w-5 h-5 hidden dark:block mx-auto my-auto" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          <path
            className="fill-current text-color2"
