    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium dark:text-white group-hover:text-slate-800 dark:group-hover:text-second_background">Acme Inc.</span>
          <svg className="w-3 h-3 shrink-0 ml-1 fill-current text-button_hover" viewBox="0 0 12 12">
