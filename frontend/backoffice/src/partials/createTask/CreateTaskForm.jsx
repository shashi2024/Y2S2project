      ...
      <div className="flex space-x-4">
        <div className="w-1/2">
          <label className="block text-sm font-medium">Task Type</label>
            ...
            {errors.taskType && <p className="text-red-500">{errors.taskType.message}</p>}
        </div>
        ...
        <div className="w-1/3">
          ...
          <input
            {...register("date", { 
              ...
              validate: value => new Date(value) >= new Date().setHours(0,0,0,0) || "Date must be current or future date"
            })}
            type="date"
            className="mt-1 block w-full rounded-md border-second_background shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        />
