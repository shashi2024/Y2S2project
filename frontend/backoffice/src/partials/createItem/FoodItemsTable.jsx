...
function FoodItemsTable() {
  ...
  const foodItems = [
    { id: 1, code: '67346469149343983', name: 'Milk Coffee', category: 'Category 1', subCategory: 'Coffee', price: '$10.00' },
    { id: 2, code: '67346469149343983', name: 'Milk Coffee', category: 'Category 1', subCategory: 'Coffee', price: '$10.00' },
  ];
        ...
        {selectedItem && (
          <form onSubmit={handleSave}>
            ...
            <div className='p-3'>
              ...
              <input type="text" name="category" value={selectedItem.category} onChange={handleChange} className="mt-1 block w-full rounded-md border-second_background shadow-sm focus:border-button_color focus:ring focus:ring-color focus:ring-opacity-5"/>
            </div>
            <div className='p-3'>
              <label className="block text-sm font-medium">Sub Category:</label>
              <input type="text" name="subCategory" value={selectedItem.subCategory} onChange={handleChange} className="mt-1 block w-full rounded-md border-second_background shadow-sm focus:border-button_color focus:ring focus:ring-color focus:ring-opacity-5"/>
            </div>
            <div className='p-3'>
