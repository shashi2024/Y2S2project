        ...
        <div className="check">
          ...
          <div className="checklb">
            ...
            <select className="secroom" name="rooms" id="rooms">
              <option className="optroom" value="royal room">
                Royal Room
              </option>
              <option className="optroom" value="deluxe room">
                Deluxe Room
              </option>
              <option className="optroom" value="double room">
                Double Room
              </option>
              <option className="optroom" value="single room">
                Single Room
              </option>
            </select>
          </div>
